...
`;let Ce=class extends ce{constructor(){super(...arguments),this.zones=[]}render(){const e=this.zones.filter(e=>e.isActive);return 0===e.length?q:V`
      <svg
        viewBox="0 0 100 100"
        preserveAspectRatio="none"
        xmlns="http://www.w3.org/2000/svg"
    ...
    `}_renderVerticesAsHtml(){return this.polygon.map(([e,t],o)=>{const i=0===o&&!this._isClosed&&this.polygon.length>2,n=this._draggingIndex===o;return V`
        ...
        `})}_renderLines(){if(this.polygon.length<2)return q;const e=[],t=this._isClosed?[...this.polygon,this.polygon[0]]:this.polygon;for(let o=0;o<t.length-1;o++){const[i,n]=t[o],[s,r]=t[o+1];e.push(V`
