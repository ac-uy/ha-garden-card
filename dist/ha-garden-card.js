...
`;let At=class extends ct{constructor(){super(...arguments),this.zones=[]}render(){const t=this.zones.filter(t=>t.isActive);return 0===t.length?W:B`
    ...
    `:W}};function Mt(t,e,o,i){return[Math.min(100,Math.max(0,t/o*100)),Math.min(100,Math.max(0,e/i*100))]}Et.styles=a`
    :host {
      position: absolute;
      top: 0;
      left: 0;
