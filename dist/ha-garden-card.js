...
`;let Ae=class extends ce{constructor(){super(...arguments),this.zones=[]}render(){const e=this.zones.filter(e=>e.isActive);return 0===e.length?W:B`
  ...
  `,e([ue({type:Boolean})],Se.prototype,"active",void 0),e([ue({attribute:!1})],Se.prototype,"zone",void 0),e([ue({type:String})],Se.prototype,"icon",void 0),e([fe()],Se.prototype,"_x",void 0),e([fe()],Se.prototype,"_y",void 0),Se=e([he("mower-animation")],Se);const Pe={low:20,high:40};let Ee=class extends ce{render(){if(!this.sensor||!this.hass)return W;const e=this.hass.states[this.sensor.entity],t=e?.state??"?",o=e?.attributes?.unit_of_measurement??"",[i,n]=this.sensor.position,s=parseFloat(t),a=this.sensor.thresholds??Pe,r=isNaN(s)?"#9e9e9e":function(e,t){return"type"in t?e<t.cold_danger||e>t.hot_danger?"#F44336":e<t.optimal_low||e>t.optimal_high?"#FFC107":"#4CAF50":e>t.high?"#4CAF50":e>=t.low?"#FFC107":"#F44336"}(s,a);return this.style.left=`${i}%`,this.style.top=`${n}%`,B`
                ...
                <div class="field">
                  ...
                  <div class="sensor-position-inputs">
                    ...
                    <input type="number" class="text-input" style="width:70px;"
                      .value=${String(!e.thresholds||"type"in e.thresholds?20:e.thresholds.low??20)}
                      @input=${e=>this._handleSensorThresholdChange(t,"low",e)} />
                    <label class="field-label" style="margin:0;">🟡→🟢 High &gt;</label>
                    <input type="number" class="text-input" style="width:70px;"
                      .value=${String(!e.thresholds||"type"in e.thresholds?40:e.thresholds.high??40)}
